...
async function getToDoList() {
  ...
  const response = await fetch(
    "https://playground.4geeks.com/todo/users/Silvan",
    {
      method: "GET",
    }
  );
...
async function postToDoList(newTodo) {
  ...
  const response = await fetch(
    "https://playground.4geeks.com/todo/todos/Silvan",
    {
...
//FUNCIÓN Get Users - Verificar si usuario existe
...
//FUNCIÓN Post User - Crear usuario
